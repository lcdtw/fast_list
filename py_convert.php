...
//    $_TDataKey = explode('|', $_DataKey); //ucfirst("hello world!") -----Hello world!
  ...
  function U2_Utf8_Gb($_C){
    ...
    if($_C < 0x80){ 
     ...
     return iconv('gb2312', 'gbk', $_String);  // --out, --in, --string
...
// 黄芪15克,当归9,白术15克,黄连9克,干姜9克,竹茹6克,半夏9克,淫羊藿12克,菟丝子15克,柴胡9克,川牛膝9克,枳壳9克,益母草12克,桂枝12克,五味子9克,酸枣仁18克,炙甘草6克。

// string $a = array('黄芪15克','当归9','酸枣仁18克','炙甘草6克。');
